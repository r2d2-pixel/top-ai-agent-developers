...
export async function GET() {
  ...
  lines.push('');
  lines.push(`This site independently reviews ${companies.length} ${NICHE.label} ${NICHE.providersLabel}, ranked and compared by engineering depth, framework fluency, and production track record.`);
  lines.push('');
